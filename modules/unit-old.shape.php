		...
		$quu="SELECT * FROM `unit` WHERE `unit_id`= '{$unit_id}' AND `status` = '1' LIMIT 1";
	 	...
	 	if($quu_result){
	 		if(mysqli_num_rows($quu_result) > 0){
				...
				<section class="full-cover medicom-awesome-features-sec" data-stellar-background-ratio="0.3" style="background: url('<?php echo $site_data; ?>images-list/full-cover-<?php echo $random_cover; ?>.jpg')">
				...
				<li class="middle"><a href="<?php echo $unit_link.'forum';?>"><i class="pull-right img-circle fa fa-users"></i><span>المنتدى</span></a></li>
				<li><a href="<?php echo $GLOBALS['domain'].'units';?>"><i class="pull-right img-circle fa fa-tasks"></i><span>الموضوعات</span></a></li>
				</ul>

				<div class="dna-icon-png">
				<img src="<?php echo $site_data; ?>images-list/dna-icon.png" alt="" title="">
				</div>
