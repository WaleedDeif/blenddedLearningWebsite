...
if(mysqli_num_rows($answer_result_whole)>0)
		{
			...
			$query_answer="SELECT answer_id FROM result WHERE question_id='$question_id' && student_id='$student_id'";
...
<i class="<?php if($is_selected){echo "fa fa-check medicom-check ans-i-";}else {echo "fa fa-check-x medicom-check ans-i-";}  echo $answer_id; ?>"></i>
